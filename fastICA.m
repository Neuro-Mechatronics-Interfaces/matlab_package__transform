...
%
% Syntax:       Zica = transform.fastICA(Z,r);
%               Zica = transform.fastICA(Z,r,type);
%               Zica = transform.fastICA(Z,r,type,flag);
%               [Zica, W, T, mu] = transform.fastICA(Z,r);
%               [Zica, W, T, mu] = transform.fastICA(Z,r,type);
%               [Zica, W, T, mu] = transform.fastICA(Z,r,type,flag);
%               
...
%               May 4, 2018
%
% Update:       2022-10-22 Max Murphy added to +transform namespace/package
...
[Zc, mu] = transform.centerRows(Z);
[Zcw, T] = transform.whitenRows(Zc);
